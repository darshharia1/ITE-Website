...
ITE.Pages.Home = (function () {
  ...
  <div class="home-footer-copy">© 2024 <a href="https://vnit.ac.in/" target="_blank" rel="noopener noreferrer" style="color:inherit;text-decoration:underline">VNIT Nagpur</a>. All rights reserved. Built with 💙 by ITE Program.</div>
</footer>`;
  }
...
<section class="hero-section">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">Build the Next <span class="accent">Big Thing</span><br>from VNIT</h1>
    <div class="hero-tagline">From Idea to Impact</div>
    <p class="hero-desc">A centralized platform managing the entire ITE journey — student onboarding, team formation, mentorship, startup development, evaluation, and final pitching.</p>
    <div class="hero-cta">
      <a href="#/register" class="btn btn-primary btn-xl">🚀 Join the Program</a>
      <a href="#/login" class="btn btn-ghost btn-xl">Sign In →</a>
    </div>
    <div class="hero-stats">
      <div class="hero-stat text-center"><div class="hero-stat-val">7+</div><div class="hero-stat-lbl">Startups Built</div></div>
      <div class="hero-stat text-center"><div class="hero-stat-val">50+</div><div class="hero-stat-lbl">Students Mentored</div></div>
      <div class="hero-stat text-center"><div class="hero-stat-val">4</div><div class="hero-stat-lbl">Batches Completed</div></div>
      <div class="hero-stat text-center"><div class="hero-stat-val">₹25L+</div><div class="hero-stat-lbl">Funding Raised</div></div>
    </div>
  </div>
</section>
<!-- ABOUT -->
<section class="home-section" id="about">
  <div class="section-header">
    ...
    <h2 class="section-heading">Your Complete Startup Journey, Simplified</h2>
    <p class="section-desc">ITE is VNIT's flagship entrepreneurship course, transforming engineering students into startup founders through structured mentorship and hands-on learning.</p>
  </div>
  <div class="about-grid">
    <div class="about-card-stack">
      <div class="float-card"><div class="float-icon">🚀</div><div><div class="float-label">Startup Development</div><div class="float-sub">6-stage structured program</div></div></div>
      <div class="float-card"><div class="float-icon">🤝</div><div><div class="float-label">Expert Mentorship</div><div class="float-sub">1:1 faculty guidance</div></div></div>
      <div class="float-card"><div class="float-icon">🏆</div><div><div class="float-label">Final Pitch Day</div><div class="float-sub">Industry judges & funding</div></div></div>
    </div>
    <div>
      <p style="color:var(--text-secondary);font-size:1rem;line-height:1.75;margin-bottom:14px;">The ITE program bridges the gap between academic learning and real-world entrepreneurship. Students work in cross-disciplinary teams to ideate, validate, and build actual startups over one semester.</p>
      ${['Structured 6-stage startup development track from Idea Validation to Final Pitch','Cross-functional teams with defined CEO, CTO, CFO &amp; CMO roles','Dedicated faculty mentors assigned to each team for personalized guidance','Real market validation through customer interviews and MVP development','Final pitch to industry judges with seed funding opportunities'].map(f=>`<div class="about-feature"><div class="about-check">✓</div><div class="about-feature-text">${f}</div></div>`).join('')}
    </div>
  </div>
</section>
<!-- FACULTY -->
<section class="home-section alt-bg" id="faculty">
  <div class="section-header">
    ...
    <h2 class="section-heading">Faculty &amp; Industry Mentors</h2>
    <p class="section-desc">Experienced faculty and industry veterans guide each team through the startup journey.</p>
  </div>
...
<section class="home-section" id="resources">
  <div class="section-header">
    ...
    <h2 class="section-heading">Tools &amp; Resources for Founders</h2>
    <p class="section-desc">Everything you need to build, validate, and pitch your startup idea.</p>
  </div>
  <div class="resources-grid">
    ${[['📋','Pitch Deck Template','Professional slide deck template used by top startups'],['📊','Market Research Guide','Step-by-step guide to validating your market size'],['🎤','Customer Interview Script','Proven framework for conducting user interviews'],['💰','Financial Model Template','Excel template for 3-year financial projections'],['📱','MVP Planning Canvas','Lean canvas for planning your minimum viable product'],['⚖️','Legal Startup Checklist','Essential legal steps for registering in India'],['🌐','VNIT ITE Playbook','Official program guide with timelines and evaluation criteria'],['🤝','Investor Pitch Guide','How to approach and pitch to angel investors']].map(([ic,t,d])=>`<div class="resource-card"><div class="resource-icon">${ic}</div><div><div class="resource-title">${t}</div><div class="resource-desc">${d}</div></div></div>`).join('')}
  </div>
</section>
<!-- PREVIOUS STARTUPS -->
<section class="home-section alt-bg" id="prev-startups">
  <div class="startups-preview">
    <div class="startups-header">
      <div><div class="section-eyebrow">Alumni Startups</div><h2 class="section-heading" style="margin-bottom:0">Previous Startup Ventures</h2></div>
  ...
  <div class="auth-form-wrap" style="max-width:460px">
    ...
    document.getElementById('reg-form').addEventListener('submit', e => {
      ...
      setTimeout(() => {
        ...
        if (res.success) {
          ITE.App.toast('Account created! Welcome to ITE Launch Pad 🚀', 'success');
          document.getElementById('page-content').style.padding='';
          ITE.App.route();
        } else {
          err.style.display='block'; err.textContent=res.error;
...
<div class="all-startups-hero">
  ...
  <div class="hero-metrics">
    ...
    <div class="text-center"><div class="hero-metric-val">₹25L+</div><div class="hero-metric-lbl">Total Funding</div></div>
  </div>
</div>
...
${_renderFooter()}
  ...
  <div class="startup-full-header" style="background:linear-gradient(135deg,${s.color},${s.color}99)">
    <div class="startup-full-icon">${s.emoji}</div>
